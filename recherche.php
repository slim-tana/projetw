...
$listpromotion = $promotion-> recupererpromotion($_POST['search']);
?>
<!-- ************************  !-->
  <!DOCTYPE html>
<html lang="en">
...
<body class="animsition">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="delai.php">Delai</a>
    <a class="dropdown-item" href="pourcentage.php">pourcentage</a>
