...
$listeClients=$clientCvar->recupererClient($_POST['search']);
...
<body class="animsition">
    <div class="page-wrapper">
                        ...
                        <li class="active has-sub">
                          <a class="js-arrow" href="#">
                              <i class="fas fa-tachometer-alt"></i>Client</a>
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="afficherCategorie.php"> Liste des clients</a>
                                    </li>
        ...
        <div class="page-container">
            ...
            <form class="form-inline" method="POST" action="recherchecin.php">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="cin.php"> Trie par cin</a>
    <a class="dropdown-item" href="nom.php">Trie par nom</a>
