...
$listpromotion = $promotion->afficherpromotion();
?>
<!-- ************************  !-->
  <!DOCTYPE html>
<html lang="en">
...
<body class="animsition">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="delai.php"> Trie par Delai</a>
    <a class="dropdown-item" href="pourcentage.php">Trie par pourcentage</a>
   
      <a class="dropdown-item" href="stat.php">Statistique</a>
      <a class="dropdown-item" href="email.php">Mail</a>
    <div class="dropdown-divider"></div>
                                        ...
                                        foreach($listpromotion as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="supprimerpromotion.php?id_promo=<?PHP echo $row['id_promo']; ?>"> Supprimer</a>
                                                </td>
                                                <td><a href="modifierpromotion.php?id_promo=<?PHP echo $row['id_promo']; ?>">  Modifier</a></td>
                                            </tr>
...
<?php
                                ...
                                <a href="ajoutpromotion.php">Ajouter promotion</a>
                              </div>
                              </div>
                              </div>
                            </div>
